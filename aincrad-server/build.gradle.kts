...
paperweight {
    ...
    bundlerJarName.set("aincrad")

    val aincrad = forks.register("aincrad") {
        upstream.patchDir("paperServer") {
            upstreamPath = "paper-server"
            excludes = setOf("src/minecraft", "patches", "build.gradle.kts")
            patchesDir = rootDirectory.dir("aincrad-server/paper-patches")
...
dependencies {
    implementation(project(":aincrad-api"))
...
tasks.jar {
    manifest {
        ...
        attributes(
            ...
            "Specification-Title" to "Aincrad",
